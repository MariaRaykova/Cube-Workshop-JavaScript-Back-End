...
module.exports = {
  ...
  getCreateAccessory(_, res) {
    ...
    res.render('create-accessory', { title: 'Create | Cube Workshop' });
  },
  ...
  getAttachAccessory(req, res, next) {
    ...
    Promise.all([
      ...
      res.render('attach-accessory', { title: 'Cube Workshop', cube, accessories, noAvailableAccessories: (accessories.length === 0) })
    })
  }
}